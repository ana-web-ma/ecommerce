...
// import { type ByProjectKeyRequestBuilder } from '@commercetools/platform-sdk/dist/declarations/src/generated/client/by-project-key-request-builder';
import { type ByProjectKeyRequestBuilder } from '@commercetools/importapi-sdk/dist/declarations/src/generated/client/by-project-key-request-builder';
import { tokenCache } from '../tokenCache';

export const apiPasswordFlowRoot = (): ByProjectKeyRequestBuilder => {
  ...
  return createApiBuilderFromCtpClient(client).withProjectKeyValue({
    projectKey,
  });
};
